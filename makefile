...
# Programm directly the board/mcu
# AVRDUDE_PROGRAMMER = arduino
# Using a Adruino as IPS
AVRDUDE_PROGRAMMER = avrisp

#AVRDUDE_PORT = /dev/cu.usbmodem14301	# MacOS UNO R3s (left, lower port)
#AVRDUDE_PORT = /dev/cu.usbmodem14101 # MacOS UNO R3s (right, uper port)
AVRDUDE_PORT = /dev/cu.usbserial-A9007Myg # MacOS Arduino Duemianove
...
# SRC += huffcode.c realtimeclock.c delay.c
...
# Baud for Duemilanova as programmer
